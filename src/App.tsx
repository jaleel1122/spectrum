          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-lg leading-relaxed">
                Providing quality English Medium education from Nursery to Grade X. Recognised by the Govt. of T.S.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-16">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 text-gray-400">
                <div className="flex gap-3"><MapPin className="h-5 w-5 text-red-500" /> <span>Hyderabad, Telangana</span></div>
                <div className="flex gap-3"><Phone className="h-5 w-5 text-red-500" /> <span>+91 12345 67890</span></div>
                <div className="flex gap-3"><Mail className="h-5 w-5 text-red-500" /> <span>info@spectrumhighschool.com</span></div>
              </div>
            </div>
            <div className="space-y-4">
